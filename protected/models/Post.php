...
class Post extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('image',  'file', 'allowEmpty'=> false, 'types'=> 'jpg, jpeg', 'maxSize'=> 2097152),
			array('content', 'length', 'max'=>160),
			array('tags', 'match', 'pattern'=>'/^[\w\s,]+$/', 'message'=>'Tags can only contain word characters.'),
			array('tags', 'normalizeTags'),

			array('title, status, profile', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'profile' => array(self::BELONGS_TO, 'Profile', 'author_id'),
	...
	protected function beforeDelete()
	{
		...
		{
			if(($this->author_id==Yii::app()->user->id) || Yii::app()->user->checkAccess('Admin'))
				return true;
				else
				//$model->redirect(array('site/index'));
	...
	public function search()
	{
		...
		$criteria->compare('author.username',$this->author,true);
