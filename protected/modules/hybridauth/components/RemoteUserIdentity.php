...
class RemoteUserIdentity extends CBaseUserIdentity {
	...
	public $loginProviderFirstName;
	public $loginProviderLastName;
	public $loginProviderEmail;
	public $loginProviderUserName;
	private $_adapter;
	private $_hybridAuth;
	...
	public function authenticate() {
		...
		if ($adapter->isUserConnected()) {
			...
			$this->loginProviderFirstName = $adapter->getUserProfile()->firstName;
			$this->loginProviderLastName = $adapter->getUserProfile()->lastName;
			$this->loginProviderEmail = $adapter->getUserProfile()->email;
			$this->loginProviderUserName = explode('@', $adapter->getUserProfile()->email);
			$this->loginProviderUserName = $this->loginProviderUserName[0];
